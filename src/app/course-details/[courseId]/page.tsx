...
async function CourseDetailsPage({
  ...
  const course = (await res.json()).courses.find(
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  {course.whatYouLearn ||
                    "Master essential skills and gain practical knowledge through hands-on projects and expert guidance."}
                </p>
              </div>
